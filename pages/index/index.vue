  ...
  >
    ...
    >
      ...
      <image
        ...
        src="https://static.roi-cloud.com/upload/20211230/60935669143532"
        mode="aspectFill"
      >
      </image>
      <image
        ...
        src="https://static.roi-cloud.com/upload/20211229/60935669181927"
        mode="aspectFill"
      >
      </image>
      <image
        ...
        src="https://static.roi-cloud.com/upload/20211230/60935669144124"
        mode="aspectFill"
      >
      </image>
      <image
        ...
        src="https://static.roi-cloud.com/upload/20211229/60935669184846"
        mode="aspectFill"
      >
      </image>
      <image
        ...
        src="https://static.roi-cloud.com/upload/20211230/60935669145511"
        mode="aspectFill"
      >
      </image>
      <image
        ...
        src="https://static.roi-cloud.com/upload/20211230/60935669145930"
        mode="aspectFill"
      >
      </image>
      <image
        ...
        src="https://static.roi-cloud.com/upload/20211229/60935669191217"
        mode="aspectFill"
      >
      </image>
      <image
        ...
        src="https://static.roi-cloud.com/upload/20211229/60935669191506"
        mode="aspectFill"
      >
      </image>
      ...
      <image
        ...
        src="https://static.roi-cloud.com/upload/20211230/60935669091359"
        mode="aspectFill"
      >
      </image>
      <image
      ...
      >
        <view class="rank_wrap">
          ...
          <view class="rank_list" v-else>
            <view
              v-for="(user, userIndex) in kingofKingsList"
              :key="userIndex"
              class="box_item"
            >
              <view class="box_item_left">
      ...
      <popup ref="share" width="650" bgColor="#FFF8DC">
        <view class="p_title" v-if="playTime == 0"
          >邀请好友，赢游戏次数
          <image
        ...
        <view class="share_img_wrap">
          <image
            src="https://game0.roi-cloud.com/static/images/share_red_img.png"
            mode="aspectFit"
          ></image>
        </view>
        <button
      ...
      <uni-popup ref="score" width="650">
        <view class="score_detail">
          <view class="p_title f-normal"
            >积分明细
            <image
              @click="$refs.score.close()"
              class="icon_close"
              src="https://static.roi-cloud.com/base/icon_close.png"
              mode=""
            ></image>
            ...
            <view class="score_list" v-if="scoreDetailList.length > 0">
              ...
              >
                ...
                >
                  <view
                    class="item_left"
                    v-if="Number(gameInfo.lottery_type) === 1"
                    >{{ item.name }}
                  </view>
                  <view class="item_right">
                    ...
                    <view class="item_right_time">
                      <view class="item_right_time_date"
          ...
          <view v-if="currentScoreItem == 2">
            <view class="score_list" v-if="exchangeList.length > 0">
              <scroll-view
                @scrolltolower.stop="getExchange"
                scroll-y
                style="height: 500rpx"
              >
                <view
      ...
      <popup ref="assistance" class="assistance_pop" width="630">
        ...
        <view v-if="helperInfo.prizeName">
          <view class="ass_m_title mt50"
            >在[ {{ helperInfo.gameName }} ] 获得了</view
          >
          <view class="g_img">
      ...
      <popup ref="over_popup" bgColor="#FFF8DC" class="over_popup" width="630">
        <view>
          ...
          <view v-if="gameInfo.lottery_type == 1">
            ...
            <view class="o_rank"
              >最终排名为<text
                >【第{{ rankeOpenAward.prize_source }}名】</text
              ></view
            >
            <view class="o_prize">
...
import { acceptDataPrevpage } from "@/utils/utils.js";
        ...
        getRank({
          ...
          for (let index in this.gameInfo.game_pk_plugin) {
            ...
            let item = {
              ...
              range:
                this.gameInfo.game_pk_plugin[index].end_seq == 1
                  ? "第" + num + "名"
                  : "第" +
                    num +
                    "～" +
